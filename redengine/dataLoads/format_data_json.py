...
input_json = {
    "keywords_and_keyphrases": ["apple", "machine learning", "banana", "deep learning", "AI"]
}
        ...
        # Перебор строк из поля keywords_and_keyphrases
            ...
            for item in p["keywords_or_phrases"]:
                #  print(item)
                 ...
                 if " " in item["keyword_or_phrase"]:  # Если строка содержит пробел, значит это фраза
...
output_file_path = os.path.join(current_directory, "polaroids.ai.data_fresh_updated.json")  # Указываем имя нового файла
